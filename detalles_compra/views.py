...
def lista_detalles_compra(request):
    ...
    return render(request, 'detalles_compra/lista_detalles_compra.html', {'detalles': detalles})

def detalle_detalle_compra(request, detalle_id):
    detalle = get_object_or_404(DetalleOrdenCompra, id=detalle_id)
    return render(request, 'detalles_compra/detalle_detalle_compra.html', {'detalle': detalle})
...
def crear_detalle_compra(request):
    ...
    return render(request, 'detalles_compra/crear_detalle_compra.html', {'form': form})
