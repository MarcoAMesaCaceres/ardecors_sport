...
urlpatterns = [
    ...
    path('base_configuracion/', views.base_configuracion, name='base_configuracion'),
    ...
    path('eliminar_configuraciones/', views.eliminar_configuraciones, name='eliminar_configuraciones'),
